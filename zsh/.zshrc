...
HISTSIZE=1000
SAVEHIST=1000
setopt extended_history # store execute time
setopt hist_ignore_dups # skip same command
...
# auto push directory to stack
setopt auto_pushd

# skip pushing if present
...
zstyle ':completion:*:sudo:*' command-path /usr/local/sbin /usr/local/usrc/sbin /usr/bin /sbin /bin /usr/11R6/bin
...
# vim emulation at tab completion
